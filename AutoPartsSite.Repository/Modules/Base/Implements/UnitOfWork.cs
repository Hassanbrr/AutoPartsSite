...
namespace AutoPartsSite.Repository.Modules.Base.Implements
{
    internal class UnitOfWork : IUnitOffWork
    {
        ...
        public UnitOfWork(ApplicationDbContext context, IBlogRepository blog, IContactMessageRepository contactMessage, ICollaborationRequestRepository collaborationRequest, IBlogCategoryRepository blogCategory)
        {
            _context = context;
            Blog = blog;
